...
if_count         .set    0   ;;; counting up only
nest_count	.set	0 ;;; nesting level
...
SndSema:         .res 1           ; <>0 => Sound IRQ in progress
SndPtrTmp:       .res 2
SndTmp:          .res 2
SndEnvPtr:       .res 2

;;; .segment "APPBSS" : zeropage
	.bss
  .code
...
SndActive:       .res 4            ; <>0 => channel active
SndReqStop:      .res 4
SndEnvVol:       .res 4            ; <>0 => use envelope x
SndEnvFrq:       .res 4            ; dito
SndEnvWave:       .res 4            ; dito
;>SndEnvPly       .res 4            ; dito

SndChannel:      .res 4*8          ; current values
...
SndCmdsLo:
                .byte <((SndLoop)-1)              ; count
                .byte <((SndDo)-1)
                .byte <((SndPause)-1)             ; count
                .byte <((SndNoteOff)-1)
                .byte <((SndSetInstr)-1)          ; shiferinit1,shifterinit2,feedback
                .byte <((SndNewNote2)-1)             ;
                .byte <((SndCallPattern)-1)           ; SndCallSubr
                .byte <((SndRetToSong)-1)             ; SndRetSubr
...
set0:                ldy SndOffsets,x
        ...
        .export SndStartSound
	.global SndStartSound
